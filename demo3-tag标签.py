...
# if __name__ == '__main__':
    # os.system("locust -f demo3-tag标签.py --tags category --host=http://192.168.10.137 ")  # 只执行带有category标签的任务
    # os.system("locust -f demo3-tag标签.py --exclude-tags category --host=http://192.168.10.137 ")  # 除了不执行带有category标签的任务，其它的都执行
    # os.system("locust -f demo3-tag标签.py --tags customer --exclude-tags category --host=http://192.168.10.137 ")  # 执行带有customer标签的任务，不执行带有category标签的任务
